...
![AHKMenu demo](https://github.com/wsnh2022/wsnh2022.github.io/blob/main/assets/images/projects/ahkmenu_export.gif?raw=true)

## Features

- Drag-and-drop menu item builder
- Windows shell icon picker (shell32.dll / imageres.dll)
- Export clean AutoHotkey v2 script
